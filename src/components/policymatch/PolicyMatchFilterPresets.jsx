...
const DEFAULT_PRESETS = [
  { id: "1", name: "Quick Wins", icon: "🎯", filters: { tier: "preferred", status: "optimized" } },
  { id: "2", name: "Ready to Close", icon: "✅", filters: { status: "accepted" } },
  { id: "3", name: "High Value", icon: "⭐", filters: { minValue: 75 } },
  { id: "4", name: "Needs Review", icon: "🔍", filters: { tier: ["elevated", "high"], status: "optimized" } },
  { id: "5", name: "Auto-Bindable", icon: "⚡", filters: { autoBindable: true } },
];

export default function PolicyMatchFilterPresets({ onSelectPreset }) {
